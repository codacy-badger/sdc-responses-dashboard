...
const enableModalToggle = () => {
  ...
  if (!collexID) {
    ...
    const collexModal = $("#modal-collex");
    collexModal.attr("data-backdrop", "static");
    collexModal.attr("data-keyboard", "false");
  }
};
...
const surveyTableClickEvent = (surveyTable, collexTable) =>
  $("#survey-datatable tbody").on("click", "tr", function() {
    ...
    if (surveyID) {
      const surveyShortName = $(surveyTable).data("survey-short-name");
