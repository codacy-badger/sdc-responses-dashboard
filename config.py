...
class DevelopmentConfig(Config):
    ...
    COLLECTION_EXERCISE_URL = os.getenv('COLLECTION_EXERCISE_URL', 'http://localhost:5001')
    SURVEY_URL = os.getenv('SURVEY_URL', 'http://localhost:5001')
    REPORTING_URL = os.getenv('REPORTING_URL', 'http://localhost:5001')
